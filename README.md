...
- `H`: 우측 하단 모션 안내 켜기/끄기
- `Q` 또는 `Esc`: 종료
- 카메라 미리보기 또는 모션 안내 창을 클릭한 뒤 키를 누르세요.
...
프로그램을 실행하면 각 기능과 얼굴 모션을 정리한 안내 창이 화면 우측 하단에 표시됩니다. `H` 키로 언제든 숨기거나 다시 표시할 수 있습니다. 안내가 필요 없는 사용자는 다음과 같이 처음부터 숨긴 상태로 실행할 수 있습니다.
